...
export default function HomeScreen() {
  ...
  const handleCallRobot = () => {
    ...
    sendCommand({ type: 'call_robot', sender_id: currentUser.id, status: 'coming_to_sender' });
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {robotStatus === 'in_transit' && (
        isRecipient ? (
          <TouchableOpacity style={styles.confirmSenderButton} onPress={() => markArrived()} activeOpacity={0.8}>
            <Text style={styles.callButtonIcon}>📦</Text>
